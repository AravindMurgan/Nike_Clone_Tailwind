	...
	return (
		<div className='mt-14 md:mt-16 md:mb-14 xl:mb-16 md:align-middle w-full'>
			...
			<div>
				...
				<div className='aspect-w-7 aspect-h-8 sm:aspect-w-6 sm:aspect-h-4 
			...
			<div className='mt-8 md:mt-12 w-full flex flex-col md:justify-center md:items-center'>
				...
				<div className='flex justify-start sm:justify-center items-center sm:mt-3 md:mt-5 xl:mt-7  w-full'>
					...
					<span>
						<button className='inline mt-8  w-36 md:w-52 lg:w-56  md:px-8 py-2 md:py-2 lg:py-3 
						text-base bg-gray-900 text-white rounded-full md:text-lg lg:text-xl '>
							Start a Workout
						</button>
					</span>
				</div>
