	...
	return (
		<div className='mt-14 md:mt-16 md:mb-14 xl:mb-16 md:align-middle w-full'>
			...
			<div>
				...
				<div className='aspect-w-7 aspect-h-8 sm:aspect-w-6 sm:aspect-h-5 lg:aspect-w-16 lg:aspect-h-9 '>
					<img
			...
			{/* Latest-2 */}
			<div className=' flex flex-col mt-12 w-full md:justify-center md:items-center'>
				<h3 className='font-Roboto text-4xl text-left tracking-tighter font- italic sm:text-center md:text-5xl lg:text-6xl xl:text-7xl'>
				...
				<div className='flex justify-start sm:justify-center items-center sm:mt-3 md:mt-5 xl:mt-7  w-full'>
					<span>
						<button className='inline mt-8 mr-5  w-36 md:w-52 lg:w-56  md:px-8 py-2 md:py-2 lg:py-3  text-base bg-gray-900 text-white rounded-full md:text-lg lg:text-xl '>
							Start a Run
						</button>
					</span>
					<span>
