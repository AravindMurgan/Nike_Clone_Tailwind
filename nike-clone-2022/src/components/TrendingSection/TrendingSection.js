			...
			<div className='flex flex-col sm:flex-row '>
				<div className='mb-5 sm:mr-4 md:mr-6 xl:mr-8 relative  '>
					...
					<div className='absolute bottom-6 left-3 md:bottom-5 md:left-5 lg:bottom-7 lg:left-7 xl:bottom-9 xl:left-9 '>
						<h3 className='text-base sm:text-sm md:text-lg lg:text-2xl lg:font-normal'>
							Suit Up for the Jam --- Now Available Only on the Nike App{' '}
						</h3>
						<span className='inline-block px-3 py-2 md:px-4 md:py-2 mt-2 md:mt-5 min-width-full text-base sm:text-sm md:text-lg lg:text-xl  rounded-full bg-black text-white '>
				...
				<div className='relative'>
					...
					<div className='absolute bottom-6 left-3 md:bottom-10 md:left-8 lg:bottom-16 lg:left-10  '>
						<h3 className='text-base sm:text-sm md:text-lg lg:text-2xl lg:font-normal text-white'>
							Rawdacious Pack
						</h3>
						<span className='inline-block px-3 py-2 md:px-8 md:py-2 mt-2 md:mt-5 min-width-full text-base sm:text-sm md:text-lg lg:text-xl  rounded-full bg-white text-black '>
							<button>Shop</button>
						</span>
					</div>
				</div>
